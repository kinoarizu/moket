...
class WalletPage extends StatelessWidget {
                        ...
                        BlocBuilder<UserBloc, UserState>(
                          builder: (_, userState) => Column(
                            children: [
                              ...
                              FutureBuilder(
                                future: TransactionsServices.getTransaction(
  ...
  Column generateTransactionList(List<Transactions> transactions, double width) {
    transactions.sort((transaction1, transaction2) => transaction2.time.compareTo(transaction2.time));
...
class CardReflectioClipper extends CustomClipper<Path> {
  @override
